...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admissions.create') }}" class="btn btn-light btn-sm">New Admission</a>
        </div>
    ...
    <a href="{{ route('admissions.showAssignBed', $admission->id) }}" class="btn btn-sm btn-primary mb-1">Assign Bed</a>
    <a href="{{ route('admissions.showTransfer', $admission->id) }}" class="btn btn-warning btn-sm mb-1">Transfer</a>
    <a href="{{ route('admissions.show', $admission->id) }}" class="btn btn-info btn-sm mb-1">Transfer History</a>

    {{-- NEW BUTTON FOR CONSULTATION --}}
    <a href="{{ route('inpatient.consultation.create', ['admission_id' => $admission->id]) }}" class="btn btn-secondary btn-sm mb-1">Consult</a>
</td>
